...
//   }
  ...
  function handleCallback(host: string, code: string): Promise<string> {
...
export default function SpotifyLogin() {
  ...
  handleCallback('locahost','123')

  // fetch("https://api.spotify.com/v1/users/manu1022", {
  //   // fetch("https://api.spotify.com/v1/me", {
  //         method: 'post',
  //         headers: {
